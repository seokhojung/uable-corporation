...
export default function PortfolioPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-900">
      ...
      <div 
        ref={heroRef}
        className="relative h-screen md:h-[90vh] lg:h-[85vh] flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 animate-hero-content"
      >
        {/* 동적 배경 요소 */}
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4">
          <div className="text-center">
            ...
            <div className="mb-6 md:mb-8">
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black text-slate-100 mb-4 md:mb-6 tracking-tighter leading-tight">
                PORTFOLIO
              </h1>
            ...
            {/* 서브헤드라인 */}
            <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-slate-300 mb-8 md:mb-12 lg:mb-16 max-w-2xl md:max-w-3xl lg:max-w-4xl mx-auto leading-relaxed px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 lg:gap-8 mb-8 md:mb-12 lg:mb-16 px-4">
              <div className="relative bg-slate-800/10 backdrop-blur-lg border border-slate-700/20 rounded-2xl p-6 hover:bg-slate-800/20 transition-all duration-300 group overflow-hidden">
                {/* 카드 배경 효과 */}
                ...
                <div className="relative z-10">
                  <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-r from-slate-600 to-slate-500 rounded-xl md:rounded-2xl flex items-center justify-center mx-auto mb-3 md:mb-4 group-hover:scale-110 transition-transform shadow-lg">
                    <Globe className="w-6 h-6 md:w-8 md:h-8 text-slate-100" />
                  </div>
                  <h3 className="text-lg md:text-xl font-bold text-slate-100 mb-1 md:mb-2">3D 컨피규레이터</h3>
                  <p className="text-slate-300 text-xs md:text-sm">인터랙티브 제품 구성 도구</p>
                </div>
              </div>
              ...
              <div className="relative bg-slate-800/10 backdrop-blur-lg border border-slate-700/20 rounded-2xl p-6 hover:bg-slate-800/20 transition-all duration-300 group overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-r from-slate-500 to-slate-400 rounded-xl md:rounded-2xl flex items-center justify-center mx-auto mb-3 md:mb-4 group-hover:scale-110 transition-transform shadow-lg">
                    <Code className="w-6 h-6 md:w-8 md:h-8 text-slate-100" />
                  </div>
                  <h3 className="text-lg md:text-xl font-bold text-slate-100 mb-1 md:mb-2">AR 애플리케이션</h3>
                  <p className="text-slate-300 text-xs md:text-sm">증강현실 체험 솔루션</p>
                </div>
              </div>
              ...
              <div className="relative bg-slate-800/10 backdrop-blur-lg border border-slate-700/20 rounded-2xl p-6 hover:bg-slate-800/20 transition-all duration-300 group overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-r from-slate-500 to-slate-400 rounded-xl md:rounded-2xl flex items-center justify-center mx-auto mb-3 md:mb-4 group-hover:scale-110 transition-transform shadow-lg">
                    <Award className="w-6 h-6 md:w-8 md:h-8 text-slate-100" />
                  </div>
                  <h3 className="text-lg md:text-xl font-bold text-slate-100 mb-1 md:mb-2">WebXR 갤러리</h3>
                  <p className="text-slate-300 text-xs md:text-sm">웹 기반 VR/AR 경험</p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="text-center">
                <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-slate-100 mb-1 md:mb-2">{portfolioProjects.length}</div>
                <p className="text-slate-400 text-xs md:text-sm font-medium">총 프로젝트</p>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-slate-100 mb-1 md:mb-2">12</div>
                <p className="text-slate-400 text-xs md:text-sm font-medium">기술 스택</p>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-slate-100 mb-1 md:mb-2">100%</div>
                <p className="text-slate-400 text-xs md:text-sm font-medium">성공률</p>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-slate-100 mb-1 md:mb-2">24/7</div>
      ...
      {/* 기술 스택 스크롤 섹션 */}
      <div className="py-4 md:py-6 lg:py-8 bg-slate-800">
        ...
        <div className="w-full max-w-7xl mx-auto px-4 lg:px-8 xl:px-12">
          ...
          {sortedProjects.length > 0 ? (
            ...
            <div className="text-center py-12 md:py-16 lg:py-20 animate-fade-in">
              <div className="bg-slate-800/80 backdrop-blur-lg border border-slate-700/20 shadow-xl rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-12 max-w-sm md:max-w-md mx-auto">
                <div className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 bg-slate-700/60 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6 shadow-md">
                ...
                <h3 className="text-lg md:text-xl lg:text-2xl font-semibold text-slate-100 mb-2 md:mb-3">
                  프로젝트를 찾을 수 없습니다
                </h3>
                <p className="text-slate-300 mb-6 md:mb-8 text-sm md:text-base lg:text-lg">
                  현재 표시할 프로젝트가 없습니다.
                </p>
              </div>
            </div>
